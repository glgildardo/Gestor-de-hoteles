...
function saveHotel(req, res){
    ...
    if(body.name && body.password && body.score && body.employees && body.dates && body.owner){
...
function listMinMax(req, res){
    ...
    if(body.MayorAMenorPuntaje != null){
    ...
    }else if(body.MenorAMayorPuntaje != null){
